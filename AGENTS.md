...
- `AGENTS.md.amp.example` - Instructions given to each Amp instance
- `CLAUDE.md.example` - Instructions given to each Claude Code instance
- `AGENTS.md.example` - Instructions given to each Codex instance
