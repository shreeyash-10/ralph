...
- `prompts/AGENTS.md.amp.example` - Instructions given to each Amp instance
- `prompts/CLAUDE.md.example` - Instructions given to each Claude Code instance
- `prompts/AGENTS.md.example` - Instructions given to each Codex instance
